...
ZPlat.GameState = {
  ...
  update: function(){
    ...
    //if(this.cursors.up.isDown){console.log('up arrow');}
  ...
  loadLevel: function(){
    ...
    this.player = this.add.sprite(playerArr[0].x,playerArr[0].y,'runner');
...
//    },this);
  ...
  findObjectsByType: function(targetType,tilemap,layer){
    var result = [];
    tilemap.objects[layer].forEach(function(cur){
      if(cur.properties.type == targetType){
        cur.y -= tilemap.tileHeight;
        result.push(cur);
      }
    },this);
    return result;
